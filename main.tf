...
resource "aws_internet_gateway" "internet_gateway" {
  vpc_id = aws_vpc.vpc.id
  tags = {
    Name = "Tt_Managed_internet_gateway"
  }
}
...
resource "aws_nat_gateway" "nat_gateway" {
  ...
  tags = {
    Name = "TerraformManaged_InternetGateway"
  }
}
...
#ubuntu/images/hvm-ssd-gp3/ubuntu-noble-24.04-amd64-server-20240423ami-04b70fa74e45c3917
