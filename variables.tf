...
<html>
<head>
  <title> Apache Webserver Managed by Terraform </title>
</head>
<body>
  <p> Welcome to My Website powered by AWS EC2 Auto-Scaling Group using Terraform!
</body>
</html>
EOF
}
...
variable "environment" {
  ...
  type        = string
  default     = "tf-managed-environment"
}
